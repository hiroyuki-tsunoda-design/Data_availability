...
OUTPUT_DIR = os.path.join(BASE_DIR, "classified_natcomm_2023_by_smollm2")
FINAL_OUTPUT = os.path.join(BASE_DIR, "classified_natcomm_2023_by_smollm2_all.csv")

LLAMA_MODEL = "smollm2:1.7b"
MAX_RETRY = 3
DATA_COLUMN = "data"
